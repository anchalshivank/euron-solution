...
use ntex_cors::Cors;
use referral_generation_service::controllers::{create_ref, get_health};
use referral_generation_service::repositories::ReferralRepository;
use referral_generation_service::response::ApiResponse;
use referral_generation_service::services::{ReferralService, Services};
